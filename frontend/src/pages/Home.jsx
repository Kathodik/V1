    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 leading-tight">
              Präzise <span className="bg-gradient-to-r from-teal-400 to-cyan-400 bg-clip-text text-transparent">Galvanotechnik</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/services">
                <Button size="lg" className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-6 text-lg shadow-lg shadow-teal-500/30 transition-all duration-300 hover:scale-105">
                  Metall auswählen
                  <ArrowRight className="ml-2 h-5 w-5" />
                </Button>
              </Link>
              <Link to="/contact">
                <Button size="lg" variant="outline" className="border-2 border-teal-400 text-teal-400 hover:bg-teal-400/10 px-8 py-6 text-lg transition-all duration-300 hover:scale-105">
                  Kontakt aufnehmen
                </Button>
              </Link>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Unsere <span className="text-teal-400">Dienstleistungen</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => {
              ...
              return (
                <Card 
                  key={index} 
                  className="bg-slate-800/50 border-slate-700 backdrop-blur-sm hover:border-teal-500/50 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-teal-500/10"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
                Warum <span className="text-teal-400">Kathodik</span>?
              </h2>
            ...
            <div className="relative">
              <div className="aspect-square bg-gradient-to-br from-teal-500/20 to-cyan-500/20 rounded-3xl backdrop-blur-sm border border-teal-500/30 p-8 flex items-center justify-center">
                <img 
                  src="https://customer-assets.emergentagent.com/job_metal-coating/artifacts/4mzqxaj5_A80F545A-F543-476F-BF3A-7169BDADA022.png" 
                  alt="Kathodik Logo" 
      ...
      <section className="py-20 bg-gradient-to-r from-teal-600 to-cyan-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <Link to="/services">
            <Button size="lg" className="bg-white text-teal-600 hover:bg-slate-100 px-8 py-6 text-lg shadow-xl transition-all duration-300 hover:scale-105">
