...
const portfolioItems = [
  {
    ...
    subtitle: 'Turbolader-Komponenten',
    metal: 'Chrom',
    metalSymbol: 'Cr',
    finish: 'Hochglanz',
    description: 'Spiegelglanz-Verchromung von Turbolader-Gehäusen. Makellose, hochreflektierende Oberfläche ohne Pitting oder Wellenbildung.',
    details: ['Spiegelpoliert', 'Hochtemperaturbeständig', 'Automotive-Qualität'],
    accentColor: '#c8ccd0',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    title: 'Messing-Veredelung',
    subtitle: 'Türbeschläge & Stangen',
    metal: 'Messing',
    metalSymbol: 'Cu',
    finish: 'Antik-Messing',
    description: 'Restaurierung und Messing-Beschichtung von Türklinken und Zierstangen. Warmer Messing-Farbton mit kontrollierter Patina für authentischen Vintage-Look.',
    details: ['Restaurierung', 'Antik-Patina', 'Vintage-Optik'],
    accentColor: '#a88840',
  },
];
